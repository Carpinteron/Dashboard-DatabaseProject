  ...
  return (
    <Box m="20px">
      ...
      <Accordion falseExpanded>
        ...
        <AccordionDetails>
          <Typography font-size="16px" fontFamily={"Roboto"} fontWeight="400" lineHeight="1.5">
          El proye+cto consiste en el desarrollo de un dashboard interactivo que gestiona y visualiza información proveniente de una base de datos de vuelos en Estados Unidos.
